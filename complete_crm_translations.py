#!/usr/bin/env python3
"""
COMPLETE CRM Translations - Add ALL missing keys to fr.json, en.json, he.json
Based on full analysis of src/**/*.js files
"""
        ...
        "admin": {
            "crm": {
                ...
                "leads": {
                    ...
                    "delete_confirm_message": "Cette action est irréversible. Êtes-vous sûr de vouloir supprimer ce prospect ?",
                    "columns": {
                        "name": "Nom",
                        "email": "Email",
                        "brand": "Marque",
                ...
                "contacts": {
                    ...
                    "delete_confirm_message": "Cette action est irréversible. Êtes-vous sûr de vouloir supprimer ce contact ?",
                    "columns": {
                        "name": "Nom",
                        "company": "Entreprise",
                        "email": "Email",
                ...
                "opportunities": {
                    ...
                    "errors": {
                        "load_failed": "Échec du chargement des opportunités",
                ...
                "pipeline": {
                    ...
                    "opportunities": "opportunités",
                    "stage_updated": "Étape mise à jour avec succès",
                    ...
                    "stages": {
                        ...
                        "first_call": "Premier Appel Planifié",
                ...
                "emails": {
                    ...
                    "empty_description": "Les emails envoyés aux prospects apparaîtront ici",
                    ...
                    "deleted": "Enregistrement d'email supprimé",
                    "delete_confirm": "Voulez-vous vraiment supprimer cet enregistrement ?",
                    "received_title": "Emails Reçus",
                    "received_description": "La réception d'emails n'est pas encore implémentée dans ce CRM",
                    "received_tab": "Boîte de réception",
                    "templates_count": "modèles disponibles",
                    "templates_info": "Ces modèles sont disponibles en anglais, français et hébreu.",
                    "no_templates": "Aucun modèle disponible",
                    "no_templates_description": "Les modèles d'emails apparaîtront ici",
                    ...
                    "errors": {
                        "load_failed": "Échec du chargement de l'historique des emails",
                ...
                "settings": {
                    ...
                    "subtitle": "Gérez les utilisateurs, tags et étapes du pipeline",
                    "tabs": {
                        "users": "Utilisateurs",
                        "tags": "Tags",
                    ...
                    "tags": {
                        ...
                        "errors": {
                            ...
                            "delete_failed": "Erreur lors de la suppression du tag"
                        }
                    },
                    "stages": {
        ...
        "admin": {
            "crm": {
                ...
                "contacts": {
                    ...
                    "delete_confirm_message": "This action cannot be undone. Are you sure you want to delete this contact?",
                    "columns": {
                        "name": "Name",
                        "company": "Company",
                        "email": "Email",
                ...
                "opportunities": {
                    ...
                    "errors": {
                        "load_failed": "Failed to load opportunities",
                        "create_failed": "Failed to create opportunity",
                        "update_failed": "Failed to update opportunity",
                        "delete_failed": "Failed to delete opportunity"
                    }
                },
                "pipeline": {
                ...
                "emails": {
                    ...
                    "empty_description": "Emails sent to leads will appear here",
                    ...
                    "deleted": "Email record deleted",
                    "delete_confirm": "Do you want to delete this email record?",
                    "received_title": "Received Emails",
                    "received_description": "Email reception is not yet implemented in this CRM",
                    "received_tab": "Inbox",
                    "templates_count": "templates available",
                    "templates_info": "These templates are available in English, French, and Hebrew.",
                    "no_templates": "No templates available",
                    "no_templates_description": "Email templates will appear here",
                    ...
                    "errors": {
                        "load_failed": "Failed to load email history",
                        "templates_load_failed": "Failed to load templates",
                        "delete_failed": "Failed to delete email record"
                    }
                },
                "users": {
                    "title": "Users",
                ...
                "settings": {
                    "title": "CRM Settings",
                    "subtitle": "Manage users, tags, and pipeline stages",
                    "tabs": {
                        "users": "Users",
                        "tags": "Tags",
                    ...
                    "tags": {
                        ...
                        "errors": {
                            "create_failed": "Error creating tag",
                            "delete_failed": "Error deleting tag"
                        }
                    },
                    "stages": {
                        "add": "Add Stage",
                        ...
                        "errors": {
                            "create_failed": "Error creating stage",
                            "update_failed": "Error updating stage",
                            "delete_failed": "Error deleting stage"
                        }
                    },
                    "errors": {
                        "load_failed": "Error loading settings"
                    }
                },
                "common": {
                    "filters": "Filters",
        ...
        "admin": {
            "crm": {
                ...
                "leads": {
                    ...
                    "delete_confirm_message": "פעולה זו לא ניתנת לביטול. האם אתה בטוח?",
                    "columns": {
                        "name": "שם",
                        "email": "אימייל",
                        "brand": "מותג",
                ...
                "opportunities": {
                    "title": "הזדמנויות",
                    "subtitle": "נהל את ההזדמנויות העסקיות שלך",
                    "new": "הזדמנות חדשה",
                    "edit": "ערוך הזדמנות",
                    ...
                    "errors": {
                        "load_failed": "שגיאה בטעינת הזדמנויות",
                        "create_failed": "שגיאה ביצירת הזדמנות",
                        "update_failed": "שגיאה בעדכון הזדמנות",
                        "delete_failed": "שגיאה במחיקת הזדמנות"
                    }
                },
                "pipeline": {
                    "title": "צינור מכירות",
                ...
                "activities": {
                    ...
                    "errors": {
                        "load_failed": "שגיאה בטעינת פעילויות",
                        "create_failed": "שגיאה ביצירת פעילות",
                        "update_failed": "שגיאה בעדכון פעילות",
                        "delete_failed": "שגיאה במחיקת פעילות"
                    }
                },
                "emails": {
                    ...
                    "empty_description": "אימיילים שנשלחו ללידים יופיעו כאן",
                    ...
                    "message": "הודעה",
                    "message_placeholder": "כתוב את ההודעה שלך כאן...",
                    "sending": "שולח...",
                    "send": "שלח",
                    "sent_success": "אימייל נשלח בהצלחה",
                    "send_failed": "שליחת אימייל נכשלה",
                    "error_empty": "אנא מלא נושא והודעה",
                    "deleted": "רשומת אימייל נמחקה",
                    "delete_confirm": "האם למחוק את רשומת האימייל?",
                    "received_title": "אימיילים שהתקבלו",
                    "received_description": "קבלת אימיילים עדיין לא מיושמת ב-CRM זה",
                    "received_tab": "תיבת דואר",
                    "templates_count": "תבניות זמינות",
                    "templates_info": "תבניות אלו זמינות באנגלית, צרפתית ועברית.",
                    "no_templates": "אין תבניות זמינות",
                    "no_templates_description": "תבניות אימייל יופיעו כאן",
                    ...
                    "errors": {
                        "load_failed": "שגיאה בטעינת היסטוריית אימיילים",
                        "templates_load_failed": "שגיאה בטעינת תבניות",
                        "delete_failed": "שגיאה במחיקת רשומה"
                    }
                },
                "users": {
                    "title": "משתמשים",
                    ...
                    "form": {
                        ...
                        "last_name": "שם משפחה",
                        "password": "סיסמה",
                        "password_edit": "סיסמה חדשה (השאר ריק לשמור הנוכחית)",
                        "role": "תפקיד",
                    ...
                    "errors": {
                        ...
                        "update_failed": "שגיאה בעדכון משתמש",
                        "delete_failed": "שגיאה במחיקת משתמש"
                    }
                },
                "settings": {
                    "title": "הגדרות CRM",
                    "subtitle": "נהל משתמשים, תגיות ושלבי צינור",
                    "tabs": {
                        "users": "משתמשים",
                        "tags": "תגיות",
                        "stages": "שלבי צינור"
                    ...
                    "tags": {
                        ...
                        "errors": {
                            "create_failed": "שגיאה ביצירת תגית",
                            "delete_failed": "שגיאה במחיקת תגית"
                        }
                    },
                    "stages": {
                        "add": "הוסף שלב",
                        ...
                        "errors": {
                            "create_failed": "שגיאה ביצירת שלב",
                            "update_failed": "שגיאה בעדכון שלב",
                            "delete_failed": "שגיאה במחיקת שלב"
                        }
                    },
                    "errors": {
                        "load_failed": "שגיאה בטעינת הגדרות"
                    }
                },
                "common": {
                    "filters": "מסננים",
...
def deep_merge(base, update):
    """Deep merge update into base, adding missing keys"""
...
def process_file(lang):
    ...
    # Merge translations
    if lang in COMPLETE_TRANSLATIONS:
        deep_merge(data, COMPLETE_TRANSLATIONS[lang])
...
def main():
    print("=" * 60)
    print("  COMPLETE CRM Translation Update")
    print("=" * 60)
    print()
