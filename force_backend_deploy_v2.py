#!/usr/bin/env python3
"""
Force Backend Deployment via Render API (Clean Cache V2)
"""
import os
import requests
import time
...
print(f"🚀 Triggering deploy for Backend {SERVICE_ID}...")
url = f"https://api.render.com/v1/services/{SERVICE_ID}/deploys"

try:
    # Always try to clear cache for a persistent fix
    resp = requests.post(url, headers=HEADERS, json={"clearCache": "clear"})
    print(f"📥 Status: {resp.status_code}")
    
    # Render returns 201 or 202
