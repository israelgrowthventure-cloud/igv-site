...
import { ArrowRight, TrendingUp, Globe, Users, CheckCircle } from 'lucide-react';
...
const Home = () => {
  ...
  return (
    <div className="min-h-screen pt-16">
      ...
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-gradient-to-br from-white via-blue-50 to-white py-20 lg:py-32" data-testid="hero-section">
      ...
      {/* CTA Section */}
      <section className="py-20 bg-gradient-to-r from-[#0052CC] to-[#0065FF]" data-testid="cta-section">
